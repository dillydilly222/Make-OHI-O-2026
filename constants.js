...
export const WEATHER_URL = `https://api.open-meteo.com/v1/forecast?latitude=${COLUMBUS_LAT}&longitude=${COLUMBUS_LON}&current=temperature_2m,relative_humidity_2m,weather_code,wind_speed_10m&temperature_unit=fahrenheit&wind_speed_unit=mph&timezone=auto`;
